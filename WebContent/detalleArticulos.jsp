...
<a href="inicio.jsp" class="ui-btn ui-corner-all ui-shadow ui-icon-home ui-btn-icon-left">Home</a>
  ...
  <sql:setDataSource
	...
	<sql:query var="detalle" dataSource="${ds}">
				select * from tbarticulo order by usuarioID
	</sql:query>
    ...
    <table data-role="table" data-mode="columntoggle" class="ui-responsive" id="myTable">
      <thead>
        ...
        <tr>
          ...
          <th data-priority="8">Disposicion</th>
      ...
      <tbody>
        ...
        <a href="search.jsp" class="ui-btn ui-corner-all ui-shadow ui-icon-search ui-btn-icon-left">Buscar Articulos</a>
        </div>
</body>
</html>